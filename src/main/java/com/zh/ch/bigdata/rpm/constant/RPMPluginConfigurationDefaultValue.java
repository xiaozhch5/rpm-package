...
public class RPMPluginConfigurationDefaultValue {
    ...
    public static String rpmConfigurationDescriptionDefaultValue = "build rpm from any files/dirs";

    public static String rpmConfigurationAutoRequiresDefaultValue = "no";
