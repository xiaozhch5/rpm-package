...
public class RPMConfiguration {
    ...
    public static String rpmConfigurationGroup = "rpmConfigurationGroup";

    public static String rpmConfigurationDescription = "rpmConfigurationDescription";

    public static String rpmConfigurationAutoRequires = "rpmConfigurationAutoRequires";
